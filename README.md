...
```kotlin
implementation("ir.mahozad.multiplatform:comshot:0.1.0-SNAPSHOT")
```
...
[Library on Maven Central]: https://repo1.maven.org/maven2/ir/mahozad/multiplatform/comshot/0.1.0-SNAPSHOT/
